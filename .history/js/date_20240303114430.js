...
console.log(now.toISOString()); // 2024-03-03T04:05:24.516Z
console.log(birthday.toLocaleDateString()); // m/dd/yyyy: 11/30/2002
console.log(birthday.toLocaleDateString("vi-VI")); // d/mm/yyyy: 30/11/2002

// chuyen doi ngay thanh d/mm/yyyy
myTime = new Date(
  "Sun Mar 03 2024 10:24:38 GMT+0700 (GMT+07:00)"
);
...
const preDate = myDate < 10 ? "0" : "";
const preMonth = myMonth < 10 ? "0" : "";
console.log(
  `${preDate}${myDate}/${preMonth}${myMonth}/${myYear}`
);

// setTimeout và setInterval
// setTimeout(action, miliseconds); Thuc hien 1 nhiem vu nao do sau 1 khoang thoi gian
// const timer = setTimeout(() => {
//   console.log("Call me");
// }, 3000);
// clearTimeout(timer);
// setInterval(action, miliseconds); sau 1 khoang thoi gian se thuc hien lai nhiem vu 1 lan
// setInterval(() => {
//   console.log("Call me");
// }, 3000);
// De dung thoi gian, dua setInterval vao bien
...
function tinhTong(a = 0, b = 3) {
  if (isNaN(a) === true || isNaN(b) === true) {
    alert("Vui long nhap lai du lieu");
  }
  return a + b;
}
