...
// findIndex(): tra ve vi tri tim thay dau tien trong mang thoa dieu kien
const findIndex = numbers.findIndex(
  (element) => element > 10
);
...
const listNumberDouble = listNumber((value, index, array) {
  return value*2;
});