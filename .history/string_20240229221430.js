...
console.log(test.slice(0, 11)); //Lấy ra kí tự hoặc chuỗi kí tự ở vị trí nào đó (start, end - 1)
...
//substr : Lấy ra 1 phần của string
console.log(test.substr(0, 6));
//substring : Lấy ra các kí tự của string
